...
import com.neo4j.model.GraphModelUtils;
import com.neo4j.model.GraphNode;
import com.neo4j.model.GraphProperty;
import com.neo4j.model.GraphRelationship;
...
public class GraphOutput extends BaseStep implements StepInterface {
  ...
  @Override public boolean processRow( StepMetaInterface smi, StepDataInterface sdi ) throws KettleException {
    ...
    // TODO Calculate cypher statement, parameters, ... based on field-model-mappings
    //
    ...
    if (log.isDebug()) {
      logBasic("Parameters found : "+parameters.size());
      logBasic("Merge statement : "+cypher);
    }
